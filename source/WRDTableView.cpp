...
/*  Generic Objectador menu. It has title path at the top, a highlighted field in the middle, a thin margin
...
SharedPointer<UIView::Action> WRDTableView::getAction()
{
    ...
    /*  If the returned object is a table itself, use it to create an ObjectadorMenu
